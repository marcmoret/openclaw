...
- [v5 to v6](https://github.com/deepgram/deepgram-python-sdk/blob/main/docs/Migrating-v5-to-v6.md) (current)
- [v3+ to v5](https://github.com/deepgram/deepgram-python-sdk/blob/main/docs/Migrating-v3-to-v5.md)
- [v2 to v3+](https://github.com/deepgram/deepgram-python-sdk/blob/main/docs/Migrating-v2-to-v3.md)
...
- **[API Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md)** - Complete reference for all SDK methods, parameters, and WebSocket connections
...
Our newest and most advanced speech recognition model with contextual turn detection ([Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md#listen-v2-connect)):
...
Transcribe pre-recorded audio files ([API Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md#listen-v1-media-transcribe-file)):
...
Generate natural-sounding speech from text ([API Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md#speak-v1-audio-generate)):
...
Analyze text for sentiment, topics, and intents ([API Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md#read-v1-text-analyze)):
...
Build interactive voice agents ([Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md#agent-v1-connect)):
...
- **[API Reference](https://github.com/deepgram/deepgram-python-sdk/blob/main/reference.md)** - Complete reference for all SDK methods including:
...
See [`examples/27-transcription-live-sagemaker.py`](https://github.com/deepgram/deepgram-python-sdk/blob/main/examples/27-transcription-live-sagemaker.py) for a complete working example.
...
See our [CONTRIBUTING](https://github.com/deepgram/deepgram-python-sdk/blob/main/CONTRIBUTING.md) guide.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/deepgram/deepgram-python-sdk/blob/main/LICENSE) file for details.